...
const SurfaceRequestForm = (props) => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      // }
      const { id } = existData;
      res = await SurfaceServices.requestEdit(id, req, token);
...
SurfaceRequestForm.propTypes = {
  open: PropTypes.bool.isRequired,
  handleClose: PropTypes.func.isRequired,
  existData: PropTypes.object,
};
SurfaceRequestForm.defaultProps = {
  open: false,
  handleClose: () => {},
  existData: null,
};

export default SurfaceRequestForm;
